...
namespace TRAZAAR
{
    public partial class FrmReporteSalazon : Form
    {
        public FrmReporteSalazon()
        {
            InitializeComponent();
        }
        ...
        private void EstadoGrilla()
        {
            ...
            Dgprincipal.Columns[7].DefaultCellStyle.Format = "N2";
            ...
            for (int i = 0; i < Dgprincipal.Rows.Count - 1; i++)
            {
                //if (i != 0)
                //{
                if (Dgprincipal.Rows[i].Cells[8].Value.ToString() == Dgprincipal.Rows[i + 1].Cells[8].Value.ToString())
                {    
                    Dgprincipal.Rows[i].Cells[9].Value = "";
                    Dgprincipal.Rows[i].Cells[10].Value = "";
                }
                //else
                //{
                //    Dgprincipal.Rows[i].Cells[10].Value.ToString("N2");
                //}
            ...
            if (CmbProducto.SelectedValue.ToString() != "0")
            {
                ...
                Dgprincipal.Columns[9].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                Dgprincipal.Columns[10].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        }
