    ...
    public partial class FrmPendientesDeIng2Sal: Form
    {
        ...
        private void CargaraGrilla()
        {
            ...
            try
            {
                ...
                setDataSource(dt = M.Listado("SP_GetPendientesDe2Sal", lst));
                if (dt.Rows.Count > 0)
                {
        ...
        {
            Cargarcombo("LOTESIN2SAL", CmbLote, CmbProducto.SelectedValue.ToString());
        }
        ...
        private void SendDatos()
        {
            ...
            _FrmAddProcesoAutomatico.Tipo = "2SAL";
