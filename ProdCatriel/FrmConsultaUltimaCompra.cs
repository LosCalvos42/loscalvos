...
namespace LOSCALVOS
{
    public partial class FrmConsultaUltimaCompra : Form
    {
        public FrmConsultaUltimaCompra()
        {
            InitializeComponent();
        }
        ...
        private void loadTable()
        {
            ...
            try
            {
                ...
                setDataSource(dt = M.Listado("SP_ConsultaComponentesUltimaC", lst));    //SP del reporte
            }
        ...
        private void mimprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dtr.Rows.Count > 0)
                {
                    ...
                    reporte.Load(Application.StartupPath + @"\Reportes\UltimaCompra.rpt");
