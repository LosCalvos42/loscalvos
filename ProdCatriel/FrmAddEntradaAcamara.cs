...
namespace LOSCALVOS
{
    public partial class FrmAddEntradaAcamara : Form
    {
        public FrmAddEntradaAcamara()
        {
            InitializeComponent();
        }
        ...
        private String[] AddCambioAlmacen(string CodBar, string CodAlmacen)
        {
            ...
            try
            {
                ...
                lst.Add(new ClsParametros("@CodCamara", CodAlmacen));
                ...
                M.EjecutarSP("SP_AddCambioAlmacen", ref lst);
                msj = new string[2];
                msj[0] = lst[2].Valor.ToString();
                msj[1] = lst[3].Valor.ToString();
            }
            ...
            if (valido())
            {
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        string[] msg = AddCambioAlmacen(TxtCodBar.Text,cmbTipo.SelectedValue.ToString());
