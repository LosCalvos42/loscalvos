...
namespace LOSCALVOS
{
    public partial class FrmForAddTipo : Form
    {
        public FrmForAddTipo()
        {
            InitializeComponent();
        }
        ...
        private void Inicio()
        {
            ...
            if (Tipo == "MODIFICAR")
            {
                ...
                try
                {
                    lst.Add(new ClsParametros("@listado", "FOR_FORMULATIPO"));
        ...
        private String[] AbmUser(string tipo)
        {
            ...
            try
            {
                ...
                M.EjecutarSP("SP_For_AddFormulaTipo", ref lst);
                msj = new string[2];
