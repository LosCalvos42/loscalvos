...
namespace TRAZAAR
{
    public partial class FrmAddGrupoFamilia : Form
    {
        public FrmAddGrupoFamilia()
        {
            InitializeComponent();
        }
        ...
        private void FrmAddGrupoFamilia_Load(object sender, EventArgs e)
        {
            ...
            Cargarcombo("GRUPOPRODUCTO", cmbGrupo);
            Inicio();
        ...
        private void Inicio()
        {
            ...
            if (Tipo == "MODIFICAR")
            {
                ...
                try
                {
                    lst.Add(new ClsParametros("@listado", "GRUPOFAMILIA"));
                    ...
                    if (dt.Rows.Count > 0)
                    {
                       ...
                       TxtObs.Text= dt.Rows[0][3].ToString();//,A.[ALMACEN_OBS] OBS
                        cmbGrupo.SelectedValue = dt.Rows[0][4].ToString();
        ...
        private String[] AbmUser(string tipo)
        {
            ...
            try
            {
                ...
                lst.Add(new ClsParametros("@GRUPOPRODUCTO", cmbGrupo.SelectedValue));
                ...
                M.EjecutarSP("sp_AddGrupoFamilia", ref lst);
                msj = new string[2];
