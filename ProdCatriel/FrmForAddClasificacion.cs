...
namespace LOSCALVOS
{
    public partial class FrmForAddClasificacion : Form
    {
        public FrmForAddClasificacion()
        {
            InitializeComponent();
        }
        ...
        private void Inicio()
        {
            ...
            if (Tipo == "MODIFICAR")
            {
                ...
                try
                {
                    lst.Add(new ClsParametros("@listado", "FOR_CLASIFICACION"));
        ...
        private String[] AbmUser(string tipo)
        {
            ...
            try
            {
                ...
                lst.Add(new ClsParametros("@NUMEROID", TxtCodigo.Text));
                ...
                M.EjecutarSP("SP_For_AddClasificacion", ref lst);
                msj = new string[2];
