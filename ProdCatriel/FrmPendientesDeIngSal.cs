...
namespace TRAZAAR
{
    public partial class FrmPendientesDeIngSal : Form
    {
        public FrmPendientesDeIngSal()
        {
            InitializeComponent();
        }
        ...
        private void CargaraGrilla()
        {
            ...
            try
            {
                ...
                setDataSource(dt = M.Listado("SP_GetPendientesDeSal", lst));
                if (dt.Rows.Count > 0)
                {
                    ...
                    Dgprincipal.Columns[1].DefaultCellStyle.BackColor = Color.FromArgb(142, 68, 173);
                    Dgprincipal.Columns[1].DefaultCellStyle.ForeColor = Color.White;
                    ...
                    Dgprincipal.Columns[4].DefaultCellStyle.BackColor = Color.FromArgb(255, 204, 128);
                    Dgprincipal.Columns[5].DefaultCellStyle.BackColor = Color.FromArgb(255, 204, 128);
                    Dgprincipal.Columns[6].DefaultCellStyle.BackColor = Color.FromArgb(255, 204, 128);
                    Dgprincipal.Columns[7].DefaultCellStyle.BackColor = Color.FromArgb(255, 204, 128);
                    Dgprincipal.Columns[8].DefaultCellStyle.BackColor = Color.FromArgb(179, 229, 252);
        ...
        private bool valido()
        {
            ...
            if (CmbLote.Text == "-Select-")
            {
                MessageBox.Show("Debe seleccionar un Lote", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                CmbProducto.Focus();
                return false;
            }
        ...
        {
            Cargarcombo("LOTESIN1SAL", CmbLote, CmbProducto.SelectedValue.ToString());
        }
        ...
        private void imprimir()
        {
            ...
            lst.Add(new ClsParametros("@Codprod", CmbProducto.SelectedValue));
            lst.Add(new ClsParametros("@lote", Lote));
            dt = M.Listado("SP_GetPendientesDeSal", lst);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Iniciar Proceso de Ingreso a Salazón? ", "Ingreso a Sal", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                 SendDatos();
            }
            else
        ...
        {
            FrmAddProcesoAutomatico _FrmAddProcesoAutomatico = new FrmAddProcesoAutomatico();
            _FrmAddProcesoAutomatico.StartPosition = FormStartPosition.CenterScreen;
            _FrmAddProcesoAutomatico.Lote = CmbLote.SelectedValue.ToString();
            _FrmAddProcesoAutomatico.CodProd = CmbProducto.SelectedValue.ToString();
            _FrmAddProcesoAutomatico.Tipo = "1SAL";
            _FrmAddProcesoAutomatico.Titulo = "Ingreso a Salazón";
            _FrmAddProcesoAutomatico.FechaProcesoAnterior = Convert.ToDateTime(Dgprincipal.Rows[0].Cells[1].Value.ToString());
            if (_FrmAddProcesoAutomatico.ShowDialog() == DialogResult.Yes)
            {
                Inicio();
            }
        }
